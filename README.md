...
NOTE: I recommend formatting your device's SD card in exFAT with an allocation unit size of 512 bytes before proceeding. 
This will reduce the amount of wasted space on the SD card, otherwise you could waste several GB and use 6GB instead of 2GB (for example). 
